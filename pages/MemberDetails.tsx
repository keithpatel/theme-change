    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center gap-4">
        <button 
          ...
          className="p-2 bg-white rounded-lg shadow-sm border border-gray-200 text-gray-600 hover:text-emerald-600 transition-colors"
        >
          <ArrowLeft size={20} />
        </button>
        <div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div className="lg:col-span-1 bg-white rounded-xl shadow-sm border border-gray-100 p-6">
          ...
          <div className="space-y-4">
             <div className="flex items-center gap-3 text-gray-600">
                ...
                <a href={`tel:${member.phone}`} className="hover:text-emerald-600 hover:underline">{member.phone}</a>
             </div>
        ...
        <div className="lg:col-span-2 grid grid-cols-1 sm:grid-cols-3 gap-4">
           <div className="bg-emerald-600 rounded-xl shadow-md p-6 text-white flex flex-col justify-between">
              <div>
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
        <div className="flex border-b">
          <button 
            ...
            className={`flex-1 py-4 text-sm font-bold uppercase tracking-wider transition-colors ${activeTab === 'savings' ? 'text-emerald-600 bg-emerald-50/50 border-b-2 border-emerald-600' : 'text-gray-500 hover:bg-gray-50'}`}
          >
            Savings & Fees History
          </button>
          <button 
            onClick={() => setActiveTab('loans')}
            className={`flex-1 py-4 text-sm font-bold uppercase tracking-wider transition-colors ${activeTab === 'loans' ? 'text-emerald-600 bg-emerald-50/50 border-b-2 border-emerald-600' : 'text-gray-500 hover:bg-gray-50'}`}
          >
            Loan Activity
          </button>
        </div>
            ...
            <div className="space-y-6">
              <div className="flex justify-between items-center">
                 ...
                 <div className="flex items-center gap-2 bg-gray-50 p-1 rounded-lg border">
                    ...
                    <span className="font-mono font-bold text-emerald-600 px-2">{selectedYear}</span>
                        ...
                        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3">
                           ...
                           {loan.status === 'approved' && (
                             <div className="text-right">
                                ...
                                <p className="font-bold text-emerald-600">${(loan.amount - repaid).toLocaleString()}</p>
                             </div>
                           )}
                        </div>

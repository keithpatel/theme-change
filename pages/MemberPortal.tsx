      ...
      <main className="flex-1 p-4 sm:p-6 max-w-5xl mx-auto w-full space-y-6">
        ...
        <div className="flex flex-wrap gap-2 bg-white p-1 rounded-xl shadow-sm border border-gray-100 w-full md:w-auto self-start">
           <button
             ...
             className={`flex-1 md:flex-none px-6 py-2.5 text-sm font-medium rounded-lg transition-all whitespace-nowrap ${
               activeTab === 'overview' ? 'bg-emerald-600 text-white shadow-sm' : 'text-gray-600 hover:bg-gray-50'
             }`}
           >
             Overview
           </button>
           <button
             ...
             className={`flex-1 md:flex-none px-6 py-2.5 text-sm font-medium rounded-lg transition-all whitespace-nowrap ${
               activeTab === 'loans' ? 'bg-emerald-600 text-white shadow-sm' : 'text-gray-600 hover:bg-gray-50'
             }`}
           >
             My Loans
           </button>
           <button
             ...
             className={`flex-1 md:flex-none px-6 py-2.5 text-sm font-medium rounded-lg transition-all whitespace-nowrap relative ${
               activeTab === 'guarantees' ? 'bg-emerald-600 text-white shadow-sm' : 'text-gray-600 hover:bg-gray-50'
             }`}
           >
             Guarantor Requests
        ...
        {activeTab === 'overview' && (
          <div className="space-y-6 animate-fade-in">
             ...
             <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-2">
                ...
                <div className="flex items-center gap-2 bg-white p-1 rounded-lg border border-gray-200 shadow-sm">
                   <button 
                       ...
                       className="p-1.5 hover:bg-gray-50 rounded-md text-gray-500 hover:text-emerald-600 transition-colors"
                       title="Previous Year"
                   >
                       <ChevronLeft size={18} />
                   </button>
                   <span className="font-mono font-bold text-emerald-600 px-3 select-none text-lg">{selectedYear}</span>
                   <button 
                       onClick={() => setSelectedYear(y => y + 1)} 
                       className="p-1.5 hover:bg-gray-50 rounded-md text-gray-500 hover:text-emerald-600 transition-colors"
                       title="Next Year"
             ...
             <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                ...
                <div className="bg-gradient-to-br from-emerald-600 to-emerald-700 p-6 rounded-xl shadow-md text-white flex flex-col justify-between">
                   <div className="flex justify-between items-start mb-4">
                      <div>
                         <p className="text-xs font-bold text-emerald-200 uppercase tracking-wider">Lifetime Savings</p>
                   ...
                   <p className="text-xs text-emerald-100 opacity-80">Total accumulated savings across all years</p>
                </div>
             ...
             <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
                <h3 className="text-lg font-bold text-gray-800 mb-4 flex items-center gap-2">
                    ...
                    Payment History <span className="text-emerald-600">{selectedYear}</span>
                </h3>
                <div className="grid grid-cols-3 sm:grid-cols-4 md:grid-cols-6 gap-3">
                   {months.map((month, index) => {
                      ...
                      return (
                         <div key={month} className={`p-3 rounded-lg border flex flex-col items-center justify-center gap-1 transition-colors ${
                            isPaid ? 'bg-green-50 border-green-200' : 'bg-gray-50 border-gray-100'
                         }`}>
                ...
                <form onSubmit={handleLoanRequest} className="space-y-4">
                   ...
                   <div className="pt-2">
                     <button
                       ...
                       className="w-full md:w-auto px-6 py-2.5 bg-emerald-600 hover:bg-emerald-700 text-white font-medium rounded-lg transition-colors disabled:opacity-50 shadow-sm"
                     >
                         ...
                         <div className="p-5 flex flex-col sm:flex-row justify-between gap-4">
                            ...
                            {(loan.repaymentHistory && loan.repaymentHistory.length > 0) && (
                               <button 
                                 ...
                                 className="self-start sm:self-center text-sm text-emerald-600 hover:bg-emerald-50 px-3 py-1.5 rounded-lg transition-colors flex items-center gap-1"
                               >
                               ...
                               <div key={req.id} className="border rounded-lg p-4 flex flex-col md:flex-row justify-between gap-4 items-start md:items-center hover:bg-gray-50 transition-colors">
                                  <div>
                                     <div className="flex items-center gap-2 mb-1">
                                        ...
                                        <span className="font-bold text-emerald-600">${req.amount}</span>
                                     </div>

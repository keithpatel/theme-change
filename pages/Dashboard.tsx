      ...
      <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
        <div className="flex justify-between items-center mb-6">
            ...
            <div className="flex items-center gap-2 bg-gray-50 p-1 rounded-lg border border-gray-200">
                ...
                <span className="font-mono font-bold text-emerald-600 px-2 select-none">{selectedYear}</span>
                <button 
                    onClick={() => setSelectedYear(y => y + 1)}
                    className="p-1.5 hover:bg-white hover:shadow-sm rounded text-gray-600 transition-all"
                >
          ...
          <div className="bg-white rounded-xl shadow-xl max-w-5xl w-full max-h-[90vh] flex flex-col overflow-hidden">
            ...
            <div className="p-4 border-b flex justify-between items-center bg-gray-50 print:hidden">
              ...
              <div className="flex gap-2">
                 {reportData && (
                     <button onClick={handlePrint} className="p-2 text-emerald-600 hover:bg-emerald-50 rounded-lg transition-colors" title="Print Report">
                        <Printer size={20} />
                     </button>
                 )}
                ...
                {!reportData ? (
                    ...
                    <div className="bg-white p-8 rounded-xl shadow-sm max-w-md mx-auto mt-10">
                        ...
                        <button 
                            ...
                            className="w-full py-3 bg-emerald-600 hover:bg-emerald-700 text-white rounded-lg font-medium shadow-sm flex justify-center items-center gap-2 transition-colors"
                        >
                    ...
                    <div id="printable-report" className="bg-white p-8 sm:rounded-xl shadow-sm max-w-4xl mx-auto border border-gray-200 print:border-none print:shadow-none print:max-w-none">
                        ...
                        <div className="flex justify-between items-start border-b-2 border-gray-800 pb-4 mb-6 print:mb-4">
                           ...
                           <div className="text-right">
                              <p className="text-xl font-bold text-emerald-700">CommunityCircle</p>
                        ...
                        <div className="section-container">
                            ...
                            <div className="px-2">
                                ...
                                <div className="flex justify-between items-center pt-3 border-t border-gray-800">
                                    ...
                                    <span className="text-xl font-bold text-emerald-700 font-mono">${reportData.closingBalance.toLocaleString(undefined, {minimumFractionDigits: 2})}</span>
                                </div>
                            </div>
                        </div>

    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50 px-4">
      <div className="max-w-md w-full bg-white rounded-2xl shadow-xl overflow-hidden">
        <div className="p-8 text-center bg-emerald-600">
          ...
          <p className="text-emerald-100">Savings & Loan Management</p>
        </div>

        <div className="flex border-b">
          <button
            onClick={() => { setActiveTab('member'); setError(null); }}
            className={`flex-1 py-4 font-medium text-sm focus:outline-none transition-colors ${
              activeTab === 'member' 
          ...
          {activeTab === 'admin' ? (
            <form onSubmit={handleAdminLogin} className="space-y-4">
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full bg-emerald-600 hover:bg-emerald-700 text-white font-medium py-2.5 rounded-lg transition-colors disabled:opacity-50 flex justify-center items-center"
              >
               ...
               <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-10 pr-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 outline-none transition-all tracking-widest text-lg"
                    placeholder="12345"
                  />
                </div>
